...
import Perpustakaan.popUp.PopUp_Lemari;
...
public class menuLemari extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bTambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTO/add.png"))); // NOI18N
    ...
    private void tLemariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tLemariMouseClicked
        ...
        try {
            ...
            String judul = tLemari.getValueAt(baris, 3).toString();
            String jumlah = tLemari.getValueAt(baris, 4).toString();
            String tahun_terbit = tLemari.getValueAt(baris, 5).toString();
