...
public class MenuLogSuratKeluar extends javax.swing.JPanel {
    ...
    public void loadTabel() throws ParseException {
        ...
        tb_LogSuratKeluar.getColumnModel().getColumn(1).setPreferredWidth(90); // Kolom "Kolom yang berubah"
        ...
        tb_LogSuratKeluar.getColumnModel().getColumn(4).setPreferredWidth(90); // Kolom "Waktu"
        tb_LogSuratKeluar.getColumnModel().getColumn(5).setPreferredWidth(240); // Kolom "Keterangan"
