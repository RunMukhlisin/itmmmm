...
public class MenuLogKategori extends javax.swing.JPanel {
    ...
    /**
     * Creates new form MenuLogKategori
     */
    ...
    public void loadTabel() throws ParseException {
        ...
        tb_LogKategori.getColumnModel().getColumn(1).setPreferredWidth(90); // Kolom "Kolom yang berubah"
        ...
        tb_LogKategori.getColumnModel().getColumn(4).setPreferredWidth(90); // Kolom "Waktu"
        tb_LogKategori.getColumnModel().getColumn(5).setPreferredWidth(240); // Kolom "Keterangan"
