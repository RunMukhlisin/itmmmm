 ...
 * @author SayMukhlisin
 */
public class popUpdateJenis extends javax.swing.JDialog {

    /**
     * Creates new form popTambahJenis
     */
    public popUpdateJenis(java.awt.Frame parent, boolean modal) {
         super(parent, modal);
        initComponents();
        getData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UBAH JENIS PEMBAYARAN");
 ...
 String isi = tNominal.getText().replaceAll("[^\\d]", "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpdateJenis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popUpdateJenis dialog = new popUpdateJenis(new javax.swing.JFrame(), true);
