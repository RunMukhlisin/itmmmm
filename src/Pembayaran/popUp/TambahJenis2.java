 ...
 * @author Alxxstrdy
 */
public class TambahJenis2 extends javax.swing.JDialog {

    /**
     * Creates new form TambahJenis
     */
    public TambahJenis2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        AutoID();
        cek();
    ...
    private void initComponents() {
        ...
        tID.setFont(new java.awt.Font("DM Sans 24pt Medium", 0, 14)); // NOI18N
        tID.setText("ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahJenis2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahJenis2 dialog = new TambahJenis2(new javax.swing.JFrame(), true);
