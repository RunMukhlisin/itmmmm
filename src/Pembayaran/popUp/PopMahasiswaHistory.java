...
import Pembayaran.template.DetailPembayaran;
 ...
 * @author Alxxstrdy
 */
public class PopMahasiswaHistory extends javax.swing.JDialog {

    /**
     * Creates new form PopMahasiswa
     */
    public PopMahasiswaHistory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadAngkatan();
        loadProdi();
    ...
    private void initComponents() {
        ...
        tbMahasiswa.setFont(new java.awt.Font("DM Sans 24pt Medium", 0, 12)); // NOI18N
        ...
        cProdi.setFont(new java.awt.Font("DM Sans 24pt SemiBold", 0, 12)); // NOI18N
    ...
    private void tbMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMahasiswaMouseClicked
        dataTabel();
        pnKonten.removeAll();
        pnKonten.add(new DetailPembayaran());
        pnKonten.repaint();
        pnKonten.revalidate();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopMahasiswaHistory dialog = new PopMahasiswaHistory(new javax.swing.JFrame(), true);
