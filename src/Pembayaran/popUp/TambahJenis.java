 ...
 * @author Alxxstrdy
 */
public class TambahJenis extends javax.swing.JDialog {

    /**
     * Creates new form TambahJenis
     */
    public TambahJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        AutoID();
        cek();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahJenis dialog = new TambahJenis(new javax.swing.JFrame(), true);
