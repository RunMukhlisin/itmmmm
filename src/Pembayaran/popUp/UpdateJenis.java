...
import Pembayaran.template.pnJenisPembayaran;
 ...
 * @author Alxxstrdy
 */
public class UpdateJenis extends javax.swing.JDialog {

    /**
     * Creates new form TambahJenis
     */
    public UpdateJenis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        getData();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(173, 217, 216));

        jLabel1.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("UPDATE JENIS PEMBAYARAN");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        jLabel2.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 14)); // NOI18N
        jLabel2.setText("ID");

        tID.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 14)); // NOI18N
        tID.setText("ID");

        jLabel4.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 14)); // NOI18N
        jLabel4.setText("Nama Jenis Pembayaran");

        tNama.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 12)); // NOI18N

        tNominal.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 12)); // NOI18N
        ...
        bUbah.setBackground(new java.awt.Color(173, 217, 216));
        bUbah.setFont(new java.awt.Font("DM Sans 18pt Medium", 0, 12)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(130, 130, 130)
                .addComponent(bUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tNominalKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tNominalKeyReleased
                ...
                tNominal.setText(df.format(nom));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateJenis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateJenis dialog = new UpdateJenis(new javax.swing.JFrame(), true);
...
void getData(){
    ...
    tNama.setText(jenis_pembayaran.getNama_jenis());
    String nominal = String.valueOf(jenis_pembayaran.getNominal()).replaceAll("[^\\d]", "");
