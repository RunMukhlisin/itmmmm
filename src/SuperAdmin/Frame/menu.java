...
import Pembayaran.template.Main;
import Perpustakaan.FRAME.menuUtama;
import Manajemen_Surat.Frame.MenuUtama;
import Inventaris.Frame.MainInv;
import Buku_Induk.Frame.menuBukuinduk;
...
public class menu extends javax.swing.JFrame {
    ...
    public menu() {
        initComponents();
        tusername.setText(session.getNama());
        ...
        System.out.println(session.getPriv_bukuInduk());
        System.out.println(session.getPriv_inventaris());
        System.out.println(session.getPriv_kepegawaian());
        System.out.println(session.getPriv_pembayaran());
        System.out.println(session.getPriv_perpustakaan());
        System.out.println(session.getPriv_surat());
    ...
    private void initComponents() {
        ...
        tusername.setFont(new java.awt.Font("DM Sans SemiBold", 0, 18)); // NOI18N
        ...
        jPanel1.add(pnlogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 520, -1, 30));
    ...
    private void KPGGRAYMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KPGGRAYMouseEntered
        if (session.getPriv_kepegawaian() == 1) {
    ...
    private void BUKUGRAYMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BUKUGRAYMouseEntered
        if (session.getPriv_bukuInduk() == 1) {
    ...
    private void PEMBAGRAY1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PEMBAGRAY1MouseEntered
        if (session.getPriv_pembayaran() == 1) {
    ...
    private void IVEGRAYMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IVEGRAYMouseEntered
        if (session.getPriv_inventaris() == 1) {
    ...
    private void PERPUSGRAYMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PERPUSGRAYMouseEntered
        if (session.getPriv_perpustakaan() == 1) {
    ...
    private void KPGBLUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KPGBLUMouseClicked
        new MainMenu().setVisible(true);
        dispose();

    }//GEN-LAST:event_KPGBLUMouseClicked

    private void BUKUBLUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BUKUBLUMouseClicked
        dispose();
        new menuBukuinduk().setVisible(true);
    }//GEN-LAST:event_BUKUBLUMouseClicked

    private void IVEBLUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IVEBLUMouseClicked
        dispose();
        new MainInv().setVisible(true);
    }//GEN-LAST:event_IVEBLUMouseClicked

    private void MANABLUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MANABLUMouseClicked
        dispose();
        new MenuUtama().setVisible(true);
    }//GEN-LAST:event_MANABLUMouseClicked

    private void PERPUSBLUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PERPUSBLUMouseClicked
        dispose();
        new menuUtama().setVisible(true);
    }//GEN-LAST:event_PERPUSBLUMouseClicked
